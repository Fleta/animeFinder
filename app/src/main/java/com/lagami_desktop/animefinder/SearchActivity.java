            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        responseObject.setBanner_uri(Uri.parse(object.getString("image_url_banner")));
                        responseObject.setTitle(object.getString("title_japanese"));
                        responseObject.setSynopsis(object.getString("description"));
                        responseObject.setMisc(object.getString("title_romaji"), object.getString("source"), Integer.toString(object.getInt("average_score")));
