    ...
    public AnimeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("synopsis", reqObject.getSynopsis());
                bundle.putString("cover_uri", String.valueOf(reqObject.getCover_uri()));
                bundle.putString("banner_uri", String.valueOf(reqObject.getBanner_uri()));
                bundle.putString("subtitle", reqObject.getSubtitle());
                bundle.putString("source", reqObject.getSource());
                bundle.putString("avgscore", reqObject.getAvgscore());
